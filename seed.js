...
const PROTOCOLS_CATALOG = {
  ...
  "protocolo_7": {
    id: "protocolo_7",
    name: "PROTOCOLO 7 — PPLUL",
    goal: "Hipertrofia (LD Consultoria · 5 dias)",
    level: "Intermediário/Avançado",
    cardio: "Cardio opcional 20-30min ao final. Prioridade é a musculação; cardio não deve comprometer a recuperação das pernas.",
    notes: [
      "Divisão de 5 dias: Seg=Push, Ter=Pull, Qua=Legs, Qui=Upper, Sex=Lower. Sábado e domingo livres.",
      "CLUSTER (nas séries marcadas): na última série, chegue perto da falha, descanse 15-20s e faça mais 2-4 reps. Repita 2 vezes.",
      "Descansos sugeridos: 6-8 reps ~120s / 8-12 reps ~90s / 12-15 reps ~60s (ajuste conforme necessidade).",
      "Dupla progressão: bateu o topo da faixa em todas as séries? Suba a carga na próxima sessão."
    ],
    workouts: [
      {
        letter: "A", name: "Push", sub: "Peito · Ombros · Tríceps", color: "#4A9EFF", icon: "💪", position: 0,
        exercises: [
          { name: "Supino Inclinado com Barra", sets: 4, reps: "6 a 8", rest: 120, position: 0, method: null,
            instructions: "4x6-8 — peito superior", muscles_primary: ["Peito"], muscles_secondary: ["Ombros","Tríceps"],
            steps: ["Banco inclinado 30-45°, pegada pouco mais aberta que os ombros.","Desça a barra controlado até a linha do peito superior.","Empurre sem travar os cotovelos no topo."] },
          { name: "Supino Reto com Halteres", sets: 3, reps: "8 a 12", rest: 90, position: 1, method: "cluster",
            instructions: "3x8-12 CLUSTER — peito geral", muscles_primary: ["Peito"], muscles_secondary: ["Tríceps","Ombros"],
            steps: ["Deitado no banco reto, halteres na linha do peito, punhos pronados.","Empurre até quase estender, aproximando levemente os halteres.","Desça controlado sentindo o alongamento do peito."] },
          { name: "Crucifixo na Máquina ou Cabo", sets: 3, reps: "12 a 15", rest: 60, position: 2, method: null,
            instructions: "3x12-15 — isolador de peito", muscles_primary: ["Peito"], muscles_secondary: [],
            steps: ["Ajuste o banco/pegada com peito estufado e leve flexão de cotovelo.","Traga as mãos à frente do corpo contraindo o peito.","Volte controlado sem perder a tensão no alongamento."] },
          { name: "Desenvolvimento Máquina", sets: 3, reps: "8 a 12", rest: 90, position: 3, method: "cluster",
            instructions: "3x8-12 CLUSTER — ombro anterior/médio", muscles_primary: ["Ombros"], muscles_secondary: ["Tríceps"],
            steps: ["Sentado, costas apoiadas, pegadores na altura dos ombros.","Empurre acima da cabeça sem travar os cotovelos.","Desça controlado até os ombros."] },
          { name: "Elevação Lateral", sets: 3, reps: "12 a 15", rest: 60, position: 4, method: null,
            instructions: "3x12-15 — largura do ombro", muscles_primary: ["Ombros"], muscles_secondary: [],
            steps: ["Halteres ao lado do corpo, leve flexão no cotovelo.","Eleve lateralmente até a altura dos ombros, mindinho liderando.","Desça lento, sem balanço do tronco."] },
          { name: "Tríceps Francês", sets: 3, reps: "8 a 12", rest: 90, position: 5, method: null,
            instructions: "3x8-12 — cabeça longa do tríceps", muscles_primary: ["Tríceps"], muscles_secondary: [],
            steps: ["Sentado ou em pé, halter/barra acima da cabeça, cotovelos apontando pra cima.","Desça o peso atrás da cabeça flexionando só os cotovelos.","Estenda voltando ao topo sem abrir os cotovelos."] },
          { name: "Tríceps Corda", sets: 3, reps: "12 a 15", rest: 60, position: 6, method: null,
            instructions: "3x12-15 — tríceps geral", muscles_primary: ["Tríceps"], muscles_secondary: [],
      ...
      {
        letter: "B", name: "Pull", sub: "Costas · Post. Ombro · Trapézio · Bíceps", color: "#FF8F00", icon: "🦅", position: 1,
        exercises: [
          { name: "Barra Fixa ou Puxada Alta", sets: 4, reps: "6 a 8", rest: 120, position: 0, method: null,
            instructions: "4x6-8 — largura das costas", muscles_primary: ["Costas"], muscles_secondary: ["Bíceps"],
            steps: ["Pegada aberta pronada na barra fixa ou pulley alto.","Puxe levando o peito à barra, escápulas deprimidas.","Suba/volte controlado até estender os braços."] },
          { name: "Remada Articulada", sets: 3, reps: "8 a 12", rest: 90, position: 1, method: "cluster",
            instructions: "3x8-12 CLUSTER — espessura das costas", muscles_primary: ["Costas"], muscles_secondary: ["Bíceps"],
            steps: ["Peito apoiado, pegue os pegadores da máquina articulada.","Puxe levando os cotovelos pra trás, apertando as escápulas.","Volte controlado até estender os braços."] },
          { name: "Pulldown", sets: 3, reps: "12 a 15", rest: 60, position: 2, method: null,
            instructions: "3x12-15 — dorsal (braços estendidos)", muscles_primary: ["Costas"], muscles_secondary: [],
            steps: ["De frente pra polia alta, braços estendidos segurando a barra.","Puxe a barra até as coxas mantendo os cotovelos estendidos.","Volte controlado sentindo o dorsal alongar."] },
          { name: "Crucifixo Inverso Máquina", sets: 3, reps: "12 a 15", rest: 60, position: 3, method: null,
            instructions: "3x12-15 — posterior de ombro", muscles_primary: ["Ombros"], muscles_secondary: ["Costas"],
            steps: ["Peito no apoio da peck deck invertida, pegada neutra.","Abra os braços levando os cotovelos pra trás na altura dos ombros.","Volte controlado sem passar da linha do tronco."] },
          { name: "Encolhimento com Halteres", sets: 3, reps: "10 a 12", rest: 60, position: 4, method: null,
            instructions: "3x10-12 — trapézio", muscles_primary: ["Trapézio"], muscles_secondary: [],
            steps: ["Em pé, halteres ao lado do corpo, braços estendidos.","Eleve os ombros em direção às orelhas, sem girar.","Segure 1s no topo e desça controlado."] },
          { name: "Rosca Direta Barra", sets: 3, reps: "8 a 12", rest: 90, position: 5, method: null,
            instructions: "3x8-12 — bíceps geral", muscles_primary: ["Bíceps"], muscles_secondary: [],
      ...
      {
        letter: "C", name: "Legs", sub: "Quadríceps · Posterior · Glúteo · Panturrilha", color: "#00FF00", icon: "🍗", position: 2,
        exercises: [
          { name: "Agachamento Livre", sets: 4, reps: "6 a 8", rest: 120, position: 0, method: null,
            instructions: "4x6-8 — quadríceps/glúteos", muscles_primary: ["Quadríceps","Glúteos"], muscles_secondary: ["Isquiotibiais"],
            steps: ["Barra nos trapézios, pés na largura dos ombros.","Desça empurrando o quadril pra trás até coxas paralelas.","Suba empurrando o chão, sem travar os joelhos."] },
          { name: "Leg Press", sets: 4, reps: "8 a 12", rest: 90, position: 1, method: "cluster",
            instructions: "4x8-12 CLUSTER — coxas gerais", muscles_primary: ["Quadríceps","Glúteos"], muscles_secondary: ["Isquiotibiais"],
            steps: ["Pés na plataforma na largura dos ombros.","Desça até ~90° sem descolar a lombar do apoio.","Empurre sem travar os joelhos no topo."] },
          { name: "Cadeira Extensora", sets: 3, reps: "12 a 15", rest: 60, position: 2, method: null,
            instructions: "3x12-15 — isolador de quadríceps", muscles_primary: ["Quadríceps"], muscles_secondary: [],
            steps: ["Ajuste encosto e apoio nos tornozelos.","Estenda os joelhos com contração no topo.","Desça controlado sem deixar o peso bater."] },
          { name: "Mesa Flexora", sets: 3, reps: "10 a 12", rest: 60, position: 3, method: null,
            instructions: "3x10-12 — isolador de posterior", muscles_primary: ["Isquiotibiais"], muscles_secondary: [],
            steps: ["Deitado, apoio no calcanhar, quadril fixo no banco.","Flexione os joelhos puxando o peso até o fim.","Desça controlado sem deixar bater as placas."] },
          { name: "Stiff", sets: 3, reps: "8 a 10", rest: 120, position: 4, method: "cluster",
            instructions: "3x8-10 CLUSTER — posterior/glúteos", muscles_primary: ["Isquiotibiais","Glúteos"], muscles_secondary: [],
            steps: ["Em pé, barra à frente, joelhos levemente flexionados.","Empurre o quadril pra trás descendo a barra rente às pernas.","Suba contraindo glúteo e posterior, sem arredondar a lombar."] },
          { name: "Hip Thrust", sets: 3, reps: "8 a 12", rest: 90, position: 5, method: "cluster",
            instructions: "3x8-12 CLUSTER — glúteos", muscles_primary: ["Glúteos"], muscles_secondary: ["Isquiotibiais"],
            steps: ["Costas apoiadas no banco, barra sobre o quadril.","Eleve o quadril até o tronco ficar paralelo ao chão.","Contraia o glúteo no topo e desça controlado."] },
          { name: "Panturrilha em Pé", sets: 4, reps: "12 a 15", rest: 60, position: 6, method: null,
            instructions: "4x12-15 — panturrilha", muscles_primary: ["Panturrilha"], muscles_secondary: [],
            steps: ["Pontas dos pés na plataforma, calcanhares no ar.","Suba na ponta dos pés com contração máxima no topo.","Desça alongando bem a panturrilha."] },
          { name: "Abdominal na Polia", sets: 3, reps: "12 a 15", rest: 60, position: 7, method: null,
            instructions: "3x12-15 — abdômen", muscles_primary: ["Abdômen"], muscles_secondary: [],
            steps: ["Ajoelhado de frente pra polia alta, corda atrás da cabeça.","Flexione o tronco contraindo o abdômen, quadril fixo.","Volte controlado sem puxar com os braços."] }
        ]
      },
      {
        letter: "D", name: "Upper", sub: "Costas · Peito · Ombros · Bíceps · Tríceps", color: "#B44AFF", icon: "🔺", position: 3,
        exercises: [
          { name: "Puxada Aberta", sets: 2, reps: "6 a 10", rest: 120, position: 0, method: null,
            instructions: "2x6-10 — largura das costas", muscles_primary: ["Costas"], muscles_secondary: ["Bíceps"],
            steps: ["Pegada aberta pronada no pulley alto.","Puxe a barra ao peito superior, escápulas deprimidas.","Volte controlado até estender os braços."] },
          { name: "Remada Baixa", sets: 2, reps: "8 a 12", rest: 90, position: 1, method: "cluster",
            instructions: "2x8-12 CLUSTER — espessura das costas", muscles_primary: ["Costas"], muscles_secondary: ["Bíceps"],
            steps: ["Sentado, pés apoiados, tronco ereto segurando o triângulo.","Puxe ao abdômen levando os cotovelos pra trás.","Volte controlado sem curvar as costas."] },
          { name: "Supino Inclinado Halteres", sets: 2, reps: "6 a 10", rest: 120, position: 2, method: null,
            instructions: "2x6-10 — peito superior", muscles_primary: ["Peito"], muscles_secondary: ["Ombros","Tríceps"],
            steps: ["Banco inclinado 30-45°, halteres na linha do peito.","Empurre até quase estender sem bater os halteres.","Desça controlado sentindo o alongamento."] },
          { name: "Supino Reto Máquina", sets: 2, reps: "8 a 12", rest: 90, position: 3, method: "cluster",
            instructions: "2x8-12 CLUSTER — peito geral", muscles_primary: ["Peito"], muscles_secondary: ["Tríceps"],
            steps: ["Sentado, pegadores na linha do peito, costas apoiadas.","Empurre à frente sem travar os cotovelos.","Volte controlado mantendo a tensão."] },
          { name: "Desenvolvimento Halteres", sets: 2, reps: "6 a 10", rest: 120, position: 4, method: null,
            instructions: "2x6-10 — ombros", muscles_primary: ["Ombros"], muscles_secondary: ["Tríceps"],
            steps: ["Sentado, halteres na altura dos ombros, palmas pra frente.","Empurre acima da cabeça sem travar os cotovelos.","Desça controlado até os ombros."] },
          { name: "Elevação Lateral", sets: 2, reps: "10 a 15", rest: 60, position: 5, method: "cluster",
            instructions: "2x10-15 CLUSTER — largura do ombro", muscles_primary: ["Ombros"], muscles_secondary: [],
            steps: ["Halteres ao lado do corpo, leve flexão no cotovelo.","Eleve lateralmente até a altura dos ombros.","Desça lento sem balanço."] },
          { name: "Rosca Scott", sets: 3, reps: "8 a 12", rest: 90, position: 6, method: null,
            instructions: "3x8-12 — pico do bíceps", muscles_primary: ["Bíceps"], muscles_secondary: [],
      ...
      {
        letter: "E", name: "Lower", sub: "Posterior · Quadríceps · Glúteo · Panturrilha", color: "#FF4A6E", icon: "🦵", position: 4,
        exercises: [
          { name: "Stiff", sets: 2, reps: "6 a 10", rest: 120, position: 0, method: "cluster",
            instructions: "2x6-10 CLUSTER — posterior/glúteos", muscles_primary: ["Isquiotibiais","Glúteos"], muscles_secondary: [],
            steps: ["Em pé, barra à frente, joelhos levemente flexionados.","Empurre o quadril pra trás descendo a barra rente às pernas.","Suba contraindo glúteo e posterior."] },
          { name: "Mesa Flexora", sets: 2, reps: "10 a 12", rest: 60, position: 1, method: null,
            instructions: "2x10-12 — isolador de posterior", muscles_primary: ["Isquiotibiais"], muscles_secondary: [],
            steps: ["Deitado, apoio no calcanhar, quadril fixo.","Flexione os joelhos puxando o peso até o fim.","Desça controlado sem bater as placas."] },
          { name: "Agachamento Hack", sets: 2, reps: "6 a 10", rest: 120, position: 2, method: "cluster",
            instructions: "2x6-10 CLUSTER — quadríceps", muscles_primary: ["Quadríceps","Glúteos"], muscles_secondary: [],
            steps: ["Ombros sob os apoios, pés na plataforma na largura dos ombros.","Desça até ~90° mantendo a lombar apoiada.","Empurre sem travar os joelhos no topo."] },
          { name: "Cadeira Extensora", sets: 2, reps: "10 a 12", rest: 60, position: 3, method: null,
            instructions: "2x10-12 — isolador de quadríceps", muscles_primary: ["Quadríceps"], muscles_secondary: [],
            steps: ["Ajuste encosto e apoio nos tornozelos.","Estenda os joelhos com contração no topo.","Desça controlado."] },
          { name: "Afundo Búlgaro", sets: 2, reps: "8 a 12", rest: 90, position: 4, method: "cluster",
            instructions: "2x8-12 CLUSTER por perna — glúteo/quadríceps", muscles_primary: ["Glúteos","Quadríceps"], muscles_secondary: ["Isquiotibiais"],
            steps: ["Pé de trás apoiado no banco, halteres nas mãos.","Desça flexionando o joelho da frente até ~90°.","Suba empurrando pelo calcanhar da frente."] },
          { name: "Abdutora", sets: 2, reps: "12 a 15", rest: 60, position: 5, method: null,
            instructions: "2x12-15 — glúteo médio", muscles_primary: ["Glúteos"], muscles_secondary: [],
            steps: ["Sentado na máquina, joelhos contra os apoios.","Abra as pernas contraindo o glúteo, tronco levemente à frente.","Volte controlado sem deixar bater."] },
          { name: "Panturrilha Sentado", sets: 2, reps: "12 a 15", rest: 60, position: 6, method: "cluster",
            instructions: "2x12-15 CLUSTER — sóleo", muscles_primary: ["Panturrilha"], muscles_secondary: [],
            steps: ["Sentado, joelhos sob os apoios, pontas dos pés na plataforma.","Suba na ponta dos pés com contração máxima.","Desça alongando bem a panturrilha."] },
          { name: "Infra Suspenso", sets: 2, reps: "12 a 15", rest: 60, position: 7, method: null,
            instructions: "2x12-15 — abdômen inferior", muscles_primary: ["Abdômen"], muscles_secondary: [],
